...
def predict_cases(model, list_of_lists, output_filenames, folds, save_npz, num_threads_preprocessing,
    ...
    trainer.network = medcam.inject(trainer.network, label=0, replace=True, backend="gcam", layer='output')
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", '--input_folder',
                        default='/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/MMFAFM_BCS/heat_map/case_image/11895423'
                        ,help="Must contain all modalities for each patient in the correct"
                                                     " order (same as training). Files must be named "
                                                     "CASENAME_XXXX.nii.gz where XXXX is the modality "
                                                     "identifier (0000, 0001, etc)")
    parser.add_argument('-o', "--output_folder",
                        default='/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/MMFAFM_BCS/heat_map/case_heatmap/cat_600/11895423', help="folder for saving predictions")
    parser.add_argument('-m', '--model_output_folder',
                        default='/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/MMFAFM_BCS/data/RESULTS_FOLDER/nnUNet/cat_DS_600/Task131_DCET2Reg/MAML3_channelTrainerV2BreastRegions__nnUNetPlansv2.1',
                        help='model output folder. Will automatically discover the folds '
                             'that were '
                             'run and use those as an ensemble')
    parser.add_argument('-f', '--folds', nargs='+', default=[1], help="folds to use for prediction. Default is None "
