...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", '--input_folder',
                        default='/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/MMFAFM_BCS/heat_map/case_image'
                        ,help="Must contain all modalities for each patient in the correct"
                                                     " order (same as training). Files must be named "
                                                     "CASENAME_XXXX.nii.gz where XXXX is the modality "
                                                     "identifier (0000, 0001, etc)")
    parser.add_argument('-o', "--output_folder",
                        default='/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/MMFAFM_BCS/heat_map/case_heatmap', help="folder for saving predictions")
    ...
    parser.add_argument('-f', '--folds', nargs='+', default=[4], help="folds to use for prediction. Default is None "
