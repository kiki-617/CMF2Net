...
base = '/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/MMFAFM_BCS/data'

preprocessing_output_dir = base + '/nnUNet_preprocessed/'
# network_training_output_dir_base = base + '/RESULTS_FOLDER/'
network_training_output_dir_base = '/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/MMFAFM_BCS/data/RESULTS_FOLDER/nnUNet/CMFF_DS_1000' # 消融实验推理
