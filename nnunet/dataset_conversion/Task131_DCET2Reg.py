...
if __name__ == "__main__":
    ...
    # task_name = "Task131_DCET2Reg"
#     downloaded_data_dir_dce = "/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/MMFAFM_BCS/data/nnUNet_raw_data/Task131_DCET2Reg/images"
#     downloaded_data_dir_t2 = "/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/A2FSeg-main/data/T2_to_DCE/Dataset071_T2TumorSegReg/imagesTr"
#
#     downloaded_data_dir_dce_test = "/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/A2FSeg-main/data/T2_to_DCE/Dataset060_DCETumorSeg/imagesTs"
#     downloaded_data_dir_t2_test = "/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/A2FSeg-main/data/T2_to_DCE/Dataset071_T2TumorSegReg/imagesTs"
#
...
#         dce = join(downloaded_data_dir_dce, os.path.basename(p)) # DCE 图像
#         t2 = join(downloaded_data_dir_t2, os.path.basename(p).replace('DCE', 'T2'))   # T2 图像
#         dce_seg = join(downloaded_data_dir_dce.replace('images', 'labels'),os.path.basename(p).replace('_0000','')) # DCE 标签
#         # t2_seg = join(downloaded_data_dir_t2.replace('images', 'labels'),os.path.basename(p).replace('DCE', 'T2')) # T2 标签
#
...
#         test_patient_names.append(p.replace('_DCE_','_').replace('_0000',''))
    ...
    task_name = "Task132_externalValDCET2Reg"
    target_base = join(nnUNet_raw_data, task_name)
    downloaded_data_dir = f'/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/MMFAFM_BCS/data/nnUNet_raw_data/{task_name}/images'
    # downloaded_data_dir_test = f'/media/lyq/4dbd4ed9-dd80-4bb0-8276-9178451541d2/MMFAFM_BCS/data/nnUNet_raw_data/{task_name}/imagesTs'
    data_paths = os.listdir(downloaded_data_dir)
    # data_test_paths = os.listdir(downloaded_data_dir_test)
    train_val_patient_names = [os.path.basename(data_path).replace('_0000','') for data_path in data_paths if os.path.basename(data_path).endswith('_0000.nii.gz')]
    # test_patient_names = [os.path.basename(data_test_path).replace('_0000','') for data_test_path in data_test_paths if os.path.basename(data_test_path).endswith('_0000.nii.gz')]

    # 对 train_val_patient_names 和 test_patient_names 进行排序
    train_val_patient_names = sorted(train_val_patient_names)
    # test_patient_names = sorted(test_patient_names)

    json_dict = OrderedDict()
    json_dict['name'] = task_name
    json_dict['description'] = "MM DCE externalVal Segment"
