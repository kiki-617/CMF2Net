...
if __name__ == "__main__":
    ...
    task_name = "Task263_externalValT2DCEReg"
    ...
    train_val_patient_names = [os.path.basename(data_path).replace('_0000', '') for data_path in data_paths if
                               os.path.basename(data_path).endswith('_0000.nii.gz')]
    # test_patient_names = [os.path.basename(data_test_path).replace('_0000', '') for data_test_path in data_test_paths if
    #                       os.path.basename(data_test_path).endswith('_0000.nii.gz')]
    ...
    json_dict['description'] = "MM T2 externalVal Segment"
    json_dict['tensorImageSize'] = "4D"
    json_dict['reference'] = "see T2DCE"
    json_dict['licence'] = "see T2DCE license"
    json_dict['release'] = "0.0"
    json_dict['modality'] = { # 这里是不同的
        "0": "T2",
        "1": "DCE",
    }
    json_dict['labels'] = {
